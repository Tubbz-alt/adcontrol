...
#if CPU_AVR_ATMEGA1281 || CPU_AVR_ATMEGA1280 || CPU_AVR_ATMEGA644P
...
#elif CPU_AVR_ATMEGA32 || CPU_AVR_ATMEGA644P
	#define SPI_PORT      PORTB
	#define SPI_DDR       DDRB
...
#elif CPU_AVR_ATMEGA64 || CPU_AVR_ATMEGA644P \
	||CPU_AVR_ATMEGA128 || CPU_AVR_ATMEGA1281
	#define AVR_HAS_UART1 1
...
#if CPU_AVR_ATMEGA64 || CPU_AVR_ATMEGA644P \
	|| CPU_AVR_ATMEGA128 || CPU_AVR_ATMEGA103
	else if (!IS_CTS_ON)
	{
